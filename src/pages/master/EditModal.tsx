...
const EditModal = ({showModal,setShowModal,  selectedMember, onSave}:any) => {
  ...
  return (
    ...
    <div className="bg-white dark:bg-neutral-800 p-4 w-1/3 rounded-md shadow-lg">
    ...
    <div className="p-4 overflow-y-auto ">
        ...
        <div className="w-full mb-3">
                ...
                <input defaultValue={selectedMember.name} onChange={handleInputs} name="name" type="text" id={`input-label-with-helper-text`} className="bg-slate-100 py-2 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-400 dark:focus:ring-neutral-600" placeholder='Member Name' />
              </div>
              <div className="w-full mb-3">
                ...
                <input defaultValue={selectedMember.email} onChange={handleInputs} name="email" type="email" id={`input-label-with-helper-text`} className="bg-slate-100 py-2 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-400 dark:focus:ring-neutral-600" placeholder='Member Email' />
              </div>
              <div className='mb-3'>
              ...
              <div className='mb-3'>
                ...
                <select  defaultValue={selectedMember.loc_name} onChange={handleInputs} name="location" id={`hs-select-label`} className="bg-slate-100 py-2 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-400 dark:focus:ring-neutral-600">
