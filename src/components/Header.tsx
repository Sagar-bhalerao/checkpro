      ...
      <path d="m19.07 4.93-1.41 1.41"></path>
              ...
              <div className="hs-dropdown [--placement:bottom-right] relative inline-flex rounded-full shrink-0  size-[38px]">
                <button
                  ...
                  aria-label="Dropdown"
                >
                  <div className='  shrink-0 flex justify-center items-center size-[38px] bg-blue-100 hover:bg-blue-200 text-blue-800 rounded-full'>{user.userFName.charAt(0)}{user.userLName.charAt(0)}</div>
                  {/* <img
                ...
                >
                  ...
                  <div className="p-1.5 space-y-0.5">
                    ...
                    {/* logout */}
                    <Link
                      className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-red-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-red-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                     to="/auth/logout"
                    >
                   <CiLogout size={20} />
                     Logout
